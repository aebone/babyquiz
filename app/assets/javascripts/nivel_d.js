...
function nivelD()
{
 ...
 window.scoreD = score.numCorrectAnswers;
 ...
 el = new Element('h2');
 el.set('html', '<form action="/levels/e" method="POST"><input type="hidden" name="totalscore" value=' +  window.totalScore +'><input type="hidden" name="scored" value=' +  window.scoreD +'><input type="submit" value="Próximo Nível"></form>');
 document.id('result').adopt(el);
}

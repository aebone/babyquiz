...
function nivelG()
{
 ...
 // mudar em cada nivel
 window.scoreG = score.numCorrectAnswers;
 window.totalScore = window.totalScore + window.scoreG;
 ...
 el = new Element('h2');
 el.set('html', '<form action="/levels/h" method="POST"><input type="hidden" name="totalscore" value=' +  window.totalScore +'><input type="hidden" name="scored" value=' +  window.scoreG +'><input type="submit" value="Próximo Nível"></form>');
 document.id('result').adopt(el);
}

...
function nivelH()
{
 ...
 // mudar em cada nivel
 window.scoreH = score.numCorrectAnswers;
 window.totalScore = window.totalScore + window.scoreH;
 ...
 el = new Element('h2');
 el.set('html', '<form action="/levels/i" method="POST"><input type="hidden" name="totalscore" value=' +  window.totalScore +'><input type="hidden" name="scored" value=' +  window.scoreH +'><input type="submit" value="Próximo Nível"></form>');
 document.id('result').adopt(el);
}

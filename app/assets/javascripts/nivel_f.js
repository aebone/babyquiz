...
function nivelF()
{
 ...
 // mudar em cada nivel
 window.scoreF = score.numCorrectAnswers;
 window.totalScore = window.totalScore + window.scoreF;
 ...
 el = new Element('h2');
 el.set('html', '<form action="/levels/g" method="POST"><input type="hidden" name="totalscore" value=' +  window.totalScore +'><input type="hidden" name="scored" value=' +  window.scoreF +'><input type="submit" value="Próximo Nível"></form>');
 document.id('result').adopt(el);
}

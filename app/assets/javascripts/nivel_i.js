...
function nivelI()
{
 ...
 // mudar em cada nivel
 window.scoreI = score.numCorrectAnswers;
 window.totalScore = window.totalScore + window.scoreI;
 ...
 el = new Element('h2');
 el.set('html', '<form action="/levels/j" method="POST"><input type="hidden" name="totalscore" value=' +  window.totalScore +'><input type="hidden" name="scored" value=' +  window.scoreI +'><input type="submit" value="Próximo Nível"></form>');
 document.id('result').adopt(el);
}
